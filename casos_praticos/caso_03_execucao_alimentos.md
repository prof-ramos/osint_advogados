...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **EVD-005** | Atividade empresarial ativa e gestão de fato. | O alimentante é o gestor exclusivo e detentor de procuração com plenos poderes da empresa Brandão Prime Car Selection. | INPI e Junta Comercial de SP. | 2026-09-07 14:00 BRT | Primária | Alta | Corroborado por vídeos públicos de atendimento ao cliente e catálogo do WhatsApp. | A empresa formal está no CNPJ da genitora. | Fato Verificado (Gestão de fato demonstrada documentalmente). | Arquivo `INPI_Proc_931234567_procuracao.pdf` (Hash SHA-256: `1bd2f9277184fb4f790c27f7fd00129df1d5c0bbb714e0db2ab89c25929a6d7d`). | Desconstituir a tese de "desempregado sem renda" perante o juízo de família. |
| **EVD-006** | Capacidade econômica real e sinais exteriores de riqueza. | Declaração voluntária de faturamento e exibição contínua de veículos esportivos e viagens internacionais de luxo em eventos do setor. | Entrevista em vídeo no YouTube e perfil comercial aberto. | 2026-09-07 15:30 BRT | Secundária | Alta (Admissão pública contra si) | Corroborado pelo volume de vendas públicas documentado na rede social. | O faturamento da loja não se confunde integralmente com o lucro líquido pessoal. | Indício Forte de rendimentos superiores a R$ 40.000,00 mensais. | Arquivo `20260907_youtube_entrevista_bruno_brandao.mp4` (Hash SHA-256: `8207a2626cbbff94c0a8a42d7a0e6c127e5222405c22f215f6dcfb793cab6c01`). | Fixação de pensão alimentícia compatível com a Teoria da Aparência. |
