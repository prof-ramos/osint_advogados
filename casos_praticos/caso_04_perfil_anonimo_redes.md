...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **EVD-07** | Difamação e concorrência desleal na internet. | Publicações imputando crimes e imperícia à médica sem qualquer condenação no CRM ou processo judicial. | Instagram (`@verdades_estetica_bh`). | 2026-09-06 | Primária | Alta | Corroborado por certidão negativa disciplinar do CRM-MG. | O conteúdo pode ser apagado a qualquer momento pela operadora da conta. | Fato Verificado (Materialidade do ilícito digital). | Captura técnica completa em HTML/WARC + Hash SHA-256 + Ata Notarial perante o 1º Tabelionato de Notas de BH. | Provar a materialidade do ato ilícito e justificar a remoção urgente (CPC, art. 300). |
| **EVD-08** | Correlação de identidade do operador da conta apócrifa. | Máscara de telefone (final 84) e e-mail compatíveis com o cadastro oficial da médica concorrente, somado ao padrão de seguidores. | Instagram e Receita Federal. | 2026-09-06 | Secundária / Técnica | Média-Alta | Corroborado pelo vínculo geográfico e concorrência direta no mesmo nicho de atuação. | **A correlação OSINT não é prova conclusiva de autoria material.** | Indício Forte / Hipótese Fundamentada. | Relatório de preservação com prints de tela e logs de requisição HTTP. | Demonstrar fumus boni iuris para requisição de dados cadastrais e IPs via art. 22 do MCI. |
